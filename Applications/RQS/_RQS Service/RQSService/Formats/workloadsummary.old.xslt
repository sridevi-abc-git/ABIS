...
>
    ...
    <table id="section-1" style="border-collapse: collapse;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="width: 3.3in; text-align:left;">License Applications Received</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left">Active Permanent Licenses as of <xsl:value-of select="SECTION_1_3/@ENDDATE"/></td>
        ...
        <!--<tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left">Total Number of Assignments Pending</td>
          <td>
            <xsl:value-of select="SECTION_1_1/LICENSINGASSIGNMENTS + SECTION_1_1/PENDCOMPLAINTINVESTIGATIONS + SECTION_1_1/PENDADMININVESTIGATIONS"/>
          </td>
          <td>
            <xsl:value-of select="SECTION_1_2/LICENSINGASSIGNMENTS + SECTION_1_2/PENDCOMPLAINTINVESTIGATIONS + SECTION_1_2/PENDADMININVESTIGATIONS"/>
          </td>
          <td>
            <xsl:value-of select="SECTION_1_3/LICENSINGASSIGNMENTS + SECTION_1_3/PENDCOMPLAINTINVESTIGATIONS + SECTION_1_3/PENDADMININVESTIGATIONS"/>
          </td>
        </tr>
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">Licensing Assignments</td>
          <td><xsl:value-of select="SECTION_1_1/LICENSINGASSIGNMENTS"/></td>
          <td><xsl:value-of select="SECTION_1_2/LICENSINGASSIGNMENTS"/></td>
          <td><xsl:value-of select="SECTION_1_3/LICENSINGASSIGNMENTS"/></td>
        </tr>
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">Complaint Assignments</td>
          <td><xsl:value-of select="SECTION_1_1/PENDCOMPLAINTINVESTIGATIONS"/></td>
          <td><xsl:value-of select="SECTION_1_2/PENDCOMPLAINTINVESTIGATIONS"/></td>
          <td><xsl:value-of select="SECTION_1_3/PENDCOMPLAINTINVESTIGATIONS"/></td>
        </tr>
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">Administrative Assignments</td>
          <td><xsl:value-of select="SECTION_1_1/PENDADMININVESTIGATIONS"/></td>
          <td><xsl:value-of select="SECTION_1_2/PENDADMININVESTIGATIONS"/></td>
          <td><xsl:value-of select="SECTION_1_3/PENDADMININVESTIGATIONS"/></td>
        </tr>-->
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left">Total Number of Investigations (ABC-61) Completed</td>
          <td><xsl:value-of select="SECTION_1_1/COMPLAINTINVESTIGATIONS + SECTION_1_1/ADMININVESTIGATIONS + SECTION_1_1/POLICEREPORTINV + SECTION_1_1/ONVIEWINV + SECTION_1_1/TRACEINVESTIGATIONS"/></td>
          <td><xsl:value-of select="SECTION_1_2/COMPLAINTINVESTIGATIONS + SECTION_1_2/ADMININVESTIGATIONS + SECTION_1_2/POLICEREPORTINV + SECTION_1_2/ONVIEWINV + SECTION_1_2/TRACEINVESTIGATIONS"/></td>
          <td><xsl:value-of select="SECTION_1_3/COMPLAINTINVESTIGATIONS + SECTION_1_3/ADMININVESTIGATIONS + SECTION_1_3/POLICEREPORTINV + SECTION_1_3/ONVIEWINV + SECTION_1_3/TRACEINVESTIGATIONS"/></td>
        </tr>
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">Complaint Investigation Assignments</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">Aministrative Assignments</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">On View Assignments</td>
          <td><xsl:value-of select="SECTION_1_1/ONVIEWINV"/></td>
          <td><xsl:value-of select="SECTION_1_2/ONVIEWINV"/></td>
          <td><xsl:value-of select="SECTION_1_3/ONVIEWINV"/></td>
        </tr>
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">TRACE Assignments</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left">Accusations Filed</td>
          <td><xsl:value-of select="SECTION_1_1/ACCUSATIONS"/></td>
          <td><xsl:value-of select="SECTION_1_2/ACCUSATIONS"/></td>
          <td><xsl:value-of select="SECTION_1_3/ACCUSATIONS"/></td>
        </tr>
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">ABC</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">ABC Backtrack</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">Number of Enforcement Hearings Held</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">Dismissed</td>
        ...
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align:left; text-indent: 3em;">Penalties Imposed Following Hearing</td>
  ...
  <xsl:template match="SECTION_2">
    ...
    <table id="section-2" style="border-collapse: collapse;">
      ...
      <tbody>
        ...
        <!--<tr style="font-weight: bold;">
          <td colspan="3" style="text-align: left; padding-top: 1.5em;">APPLICATIONS - MISCELLANEOUS</td>
        </tr>
        <tr>
          <td><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</td>
          <td style="text-align: left">Number of Protest Leters Received</td>
          <td><xsl:value-of select='NUMOFPROTESTLETTERSREC'/></td>
        </tr>-->
      ...
      <tr>
        ...
        <xsl:if test="$PART='1'">
          <th rowspan="3" style="vertical-align: bottom;" >
            ABC<br/>211's<br/>REC'D
          </th>
        </xsl:if>
        <th colspan="8">ABC 220 REPORTS</th>
      </tr>
      <tr>
        <xsl:choose>
    ...
    <thead>
      <tr>
        ...
        <th colspan="3" class="th-2">
          COMPLAINT INVEST<br/>ASSIGNMENTS (ABC-61)
        </th>
        <th colspan="3" class="th-2">
          ADMINISTRATION<br/>ASSIGNMENTS (ABC-61)
        </th>
        <th colspan="3" class="th-2">
          POLICE REPORTS<br/>ASSIGNMENTS (ABC-61)
        </th>
        <th colspan="3" class="th-2">
    ...
    <table id="section-5" style="border-collapse: collapse;">
      ...
      <!--<thead>
        <tr>
          ...
          <th colspan="3">LICENSING<br/>ASSIGNMENTS (ABC-61)</th>
          <th colspan="3">COMPLAINT INVEST<br/>ASSIGNMENTS (ABC-61)</th>
          <th colspan="3">ADMINISTRATION<br/>ASSIGNMENTS (ABC-61)</th>
          <th colspan="3">POLICE REPORTS<br/>ASSIGNMENTS (ABC-61)</th>
          <th colspan="3">TRACE<br/>ASSIGNMENTS (ABC-61)</th>
        </tr>
        <tr>
          <th>REC'D</th>
          <th>COMP'D</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <xsl:value-of select="sum(OFFICE/TRACETRECEIVED)"/>
          </td>
          <td>
  ...
  <xsl:template name='SECTION_6_HD'>
    ...
    <thead>
      ...
      <tr>
        <th colspan="2">ARRESTS AND CITAIONS</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <!--<xsl:value-of select="sum(OFFICE/ABC) + sum(OFFICE/BT)"/>-->
              </td>
              <td>
  ...
  <xsl:template match="SECTION_9">
    ...
    <table id="section-9" style="border-collapse: collapse;">
      ...
      <!--<thead>
        <tr>
          <th><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</th>
          <th>TEMP/INTR'M<br/>RET PERMIT</th>
          <th>SPEC DAILY<br/>TEMP BEER/WINE</th>
          <th>DAILY ON-SALE<br/>GENERAL</th>
          <th>CATERING<br/>AUTH</th>
          <th>EVENT<br/>AUTH</th>
        </tr>
      </thead>-->
      <tbody>
        ...
        <tr>
          ...
          <!--<td>
            <xsl:value-of select="sum(OFFICE/EVENT)"/>
          </td>-->
        </tr>
      </tbody>
    </table>
  ...
  <xsl:template match="SECTION_9/OFFICE/DIVISION">
    ...
    <tr>
      ...
      <!--<td>
        <xsl:value-of select="sum(key('misc', .)/../EVENT)"/>
      </td>-->
    </tr>
